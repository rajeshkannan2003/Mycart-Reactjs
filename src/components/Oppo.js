...
export default function Oppo (){
    return (
        <Fragment>
            ...
            <div className="col-6 col-lg-5 img-fluid" id="product_image">
                <img src="./images/products/1.jpg" alt="sdf" />
            </div>
            ...
            <div className="col-6 col-lg-5 mt-5">
                ...
                <div className="stockCounter d-inline">
                 ...
                 <Link to="/BuyOppo" type="button" id="cart_btn" className="btn btn-primary d-inline ml-4">Buynow</Link>
                ...
                <hr/>
                <p id="product_seller mb-3">Sold by: <strong>MYCART</strong></p>
